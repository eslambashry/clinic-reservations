...
function setup() {
  ...
  return { labOrders, labOrderItems, labResults, labOrderNotes, testCatalog, getActiveRoleMembership, getUserSummary, getPrescriptionSummary, getCustodyEvents, useCase };
}
