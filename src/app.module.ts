 ...
 * File 12 Part 10's phase order — Identity (Phase 1) is the first.
 */
@Module({
  imports: [AppConfigModule, PrismaModule, RedisModule, CoreModule, HealthModule, IdentityAuthModule],
})
